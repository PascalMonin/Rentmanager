...
public class ReservationEditServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.setAttribute("vehicleP", reservation.getIdVehicle());
	        request.setAttribute("clientP", reservation.getIdClient());
	        request.setAttribute("beginP", reservation.getDateStart());
	        request.setAttribute("endP", reservation.getDateEnd());
		} catch (ServiceException e) {
